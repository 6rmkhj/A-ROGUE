...
// 메아리 면이 연쇄에서 되풀이하는 비율(%). 100이면 공격 한 방이 그대로 두 번
// 들어가 보스가 두 턴에 무너졌다. 감쇠를 조금 두어 폭발의 천장만 낮춘다.
#define ECHO_REPEAT_PERCENT 85
...
static const FaceInfo FACE_INFO[FACE_KIND_COUNT] = {
    ...
    {L"메아리", L"메아리", L"연쇄 슬롯에서 직전 효과 85% 반복", 17, 5, AR_COLOR(255, 139, 209)},
...
static const BossGimmickInfo BOSS_GIMMICK_INFO[GIMMICK_COUNT] = {
    ...
    {FAM_RESTORE, L"로그의 반사", L"직전 실행의 최고 슬롯 출력을 다음 기본 공격에 더합니다.", L"복제될 출력을 확인하고 방어를 준비하십시오.", L"OUTPUT COPIED", 0, 0, 0},
...
static const EnemyInfo ENEMY_INFO[ENEMY_KIND_COUNT] = {
    // ---- 레거시 11종 (활성 로스터 미참조) ----
    {L"글리치", L"글리치", 14, 4, 3, 3, 1, 0, ROLE_MOB, PATTERN_LEGACY, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(95, 225, 176)},
    {L"웜", L"웜", 18, 5, 2, 3, 1, 0, ROLE_MOB, PATTERN_LEGACY, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(170, 230, 80)},
    {L"스파이웨어", L"스파이웨어", 22, 6, 4, 3, 1, 0, ROLE_MOB, PATTERN_LEGACY, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(255, 193, 77)},
    {L"트로이 목마", L"트로이 목마", 25, 7, 3, 3, 1, 0, ROLE_MOB, PATTERN_LEGACY, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(255, 110, 95)},
    {L"파편", L"파편", 28, 7, 6, 3, 1, 0, ROLE_MOB, PATTERN_LEGACY, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(150, 150, 255)},
    {L"오염 캐시", L"오염 캐시", 24, 6, 7, 3, 1, 0, ROLE_MOB, PATTERN_LEGACY, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(90, 190, 230)},
    {L"데몬", L"데몬", 30, 8, 5, 3, 1, 0, ROLE_MOB, PATTERN_LEGACY, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(210, 105, 235)},
    {L"루트킷", L"루트킷", 34, 9, 5, 3, 1, 0, ROLE_MOB, PATTERN_LEGACY, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(235, 80, 130)},
    {L"디스크 오류", L"디스크 오류", 38, 6, 5, 3, 1, 2, ROLE_BOSS, PATTERN_BOSS, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(255, 104, 87)},
    {L"부트 섹터", L"부트 섹터", 52, 8, 7, 3, 1, 2, ROLE_BOSS, PATTERN_BOSS, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(255, 170, 70)},
    {L"포맷", L"포맷", 68, 10, 9, 3, 1, 2, ROLE_BOSS, PATTERN_BOSS, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(245, 65, 90)},
    // ---- C:\ SYSTEM ----
    ...
    {L"액세스 거부", L"ACCESS.DENIED", 41, 5, 4, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_ACCESS_DENIED, TRAIT_NONE, AR_COLOR(96, 168, 255)},
    {L"커널 패닉", L"KERNEL.PANIC", 58, 7, 6, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_KERNEL_PANIC, TRAIT_NONE, AR_COLOR(70, 140, 245)},
    {L"블루 스크린", L"BLUE.SCREEN", 68, 8, 7, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_BLUE_SCREEN, TRAIT_NONE, AR_COLOR(58, 122, 240)},
    // ---- D:\ ARCHIVE ----
    ...
    {L"복원 프로그램", L"RESTORE.EXE", 43, 5, 4, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_RESTORE_POINT, TRAIT_NONE, AR_COLOR(255, 208, 96)},
    {L"테이프 루프", L"TAPE.LOOP", 43, 7, 5, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_TAPE_LOOP, TRAIT_NONE, AR_COLOR(238, 186, 70)},
    {L"마스터 백업", L"MASTER.BACKUP", 51, 8, 7, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_MASTER_BACKUP, TRAIT_NONE, AR_COLOR(220, 165, 52)},
    // ---- E:\ REMOVABLE ----
    ...
    {L"자동 재생", L"AUTOPLAY", 42, 5, 4, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_AUTOPLAY, TRAIT_NONE, AR_COLOR(110, 235, 168)},
    {L"강제 제거", L"UNSAFE.EJECT", 60, 7, 5, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_UNSAFE_EJECT, TRAIT_NONE, AR_COLOR(84, 216, 150)},
    {L"미디어 없음", L"NO.MEDIA", 61, 8, 7, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_NO_MEDIA, TRAIT_NONE, AR_COLOR(60, 196, 128)},
    // ---- N:\ NETWORK ----
    ...
    {L"프록시", L"PROXY", 48, 5, 4, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_PROXY, TRAIT_NONE, AR_COLOR(96, 200, 245)},
    {L"라우팅 루프", L"ROUTING.LOOP", 67, 7, 6, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_ROUTING_LOOP, TRAIT_NONE, AR_COLOR(72, 180, 235)},
    {L"타임아웃", L"TIMEOUT", 75, 8, 7, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_TIMEOUT, TRAIT_NONE, AR_COLOR(52, 160, 225)},
    // ---- R:\ RAMDISK ----
    ...
    {L"누수 라이브러리", L"LEAK.DLL", 36, 5, 3, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_LEAK, TRAIT_NONE, AR_COLOR(214, 118, 240)},
    {L"힙 오버플로", L"HEAP.OVERFLOW", 53, 6, 5, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_HEAP_OVERFLOW, TRAIT_NONE, AR_COLOR(192, 92, 226)},
    {L"메모리 고갈", L"OUT.OF.MEMORY", 61, 8, 6, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_OUT_OF_MEMORY, TRAIT_NONE, AR_COLOR(170, 70, 212)},
    // ---- X:\ QUARANTINE ----
    ...
    {L"검체-13", L"SAMPLE-13", 43, 5, 4, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_SAMPLE13, TRAIT_NONE, AR_COLOR(255, 104, 92)},
    {L"샌드박스 침입", L"SANDBOX.BREACH", 60, 7, 5, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_SANDBOX_BREACH, TRAIT_NONE, AR_COLOR(240, 80, 78)},
    {L"제로데이", L"ZERO.DAY", 66, 9, 8, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_ZERO_DAY, TRAIT_NONE, AR_COLOR(255, 56, 66)},
    ...
    {L"로그 · 서명", L"SIGNATURE", 44, 6, 4, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_SIGNATURE, TRAIT_NONE, AR_COLOR(90, 235, 190)},
    {L"로그 · 반사", L"REFLECTION", 48, 4, 4, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_SEVENTEENTH, TRAIT_NONE, AR_COLOR(140, 210, 245)},
    {L"로그 · 마지막 쓰기", L"LAST.WRITE", 74, 8, 6, 0, 0, 0, ROLE_BOSS, PATTERN_BOSS, GIMMICK_LAST_WRITE, TRAIT_NONE, AR_COLOR(235, 150, 205)}
};

// 잘못된 kind가 UI·렌더에 흘러들었을 때 대신 그리는 안전 데이터.
static const EnemyInfo UNKNOWN_ENEMY_INFO =
    {L"알 수 없음", L"UNKNOWN", 1, 0, 0, 0, 0, 0, ROLE_MOB, PATTERN_LEGACY, GIMMICK_NONE, TRAIT_NONE, AR_COLOR(255, 0, 255)};
...
static const DriveInfo DRIVE_INFO[DRIVE_COUNT] = {
    ...
    {L"N:\\", L"NETWORK", L"네트워크 공유 볼륨. 지연된 응답이 오래된 종료 요청을 붙잡고 있습니다.",
    ...
    {L"A:\\", L"ROGUE", L"모든 기억과 충돌이 모인 관리자 경로. 침식된 로그가 귀환을 막고 있습니다.",
...
enum StoryKind { STORY_NONE = 0, STORY_INTRO, STORY_BOSS, STORY_LOGS, STORY_TRUTH, STORY_ENDING_RESTORE, STORY_ENDING_ROGUE, STORY_ENDING_MERGE, STORY_SHARD, STORY_MILESTONE, STORY_A_ENTRY, STORY_A_GREETING };
