...
cl /nologo /std:c++17 /O1 /Os /GL /Gw /Gy /MT /utf-8 /GR- /W4 /DUNICODE /D_UNICODE ..\src\main.cpp ..\src\screens.cpp ..\src\render.cpp ..\src\audio.cpp ..\src\music.cpp ..\src\game.cpp /Fe:AROGUE.exe /link /LTCG /SUBSYSTEM:WINDOWS /OPT:REF /OPT:ICF user32.lib gdi32.lib winmm.lib
